...
function setupNavbar() {
    ...
    if (userRole === "user") {
      dropdownContainer.innerHTML = `
        <div class="dropdown">
          ...
          <div class="dropdown-content">
            <a href="../../templates/Report.html">Report Issue</a>
            <a href="../../templates/bins.html">View Bins</a>
          </div>
        </div>
      `;
      ...
      dropdownContainer.innerHTML = `
        <div class="dropdown">
          ...
          <div class="dropdown-content">
            <a href="../../templates/managedriver.html">Manage Driver</a>
            <a href="../../templates/complaintviews.html">Complaint Views</a>
          </div>
        </div>
      `;
      ...
      dropdownContainer.innerHTML = `
        <div class="dropdown">
          ...
          <div class="dropdown-content">
            <a href="../../templates/Assigned.html">Assigned Track</a>
            <a href="../../templates/Update.html">Update Status</a>
          </div>
        </div>
      `;
    }
  ...
  if (logoutBtn) {
    logoutBtn.addEventListener("click", () => {
      ...
      window.location.href = "../../templates/dropdown.html"; // Redirect to home page
    });
  }
